...
class LedControl_Request(metaclass=Metaclass_LedControl_Request):
    ...
    def __init__(self, **kwargs):
        ...
        self.exp_type = kwargs.get('exp_type', str())
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if self.exp_type != other.exp_type:
            return False
        return True
    ...
    def exp_type(self, value):
        if __debug__:
            assert \
                ...
                "The 'exp_type' field must be of type 'str'"
...
class Metaclass_LedControl(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'mako_nolang_interfaces.srv.LedControl')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from mako_nolang_interfaces.srv import _led_control
...
class LedControl(metaclass=Metaclass_LedControl):
    from mako_nolang_interfaces.srv._led_control import LedControl_Request as Request
    from mako_nolang_interfaces.srv._led_control import LedControl_Response as Response
