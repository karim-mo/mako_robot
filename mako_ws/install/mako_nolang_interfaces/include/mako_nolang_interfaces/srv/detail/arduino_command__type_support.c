...
static rosidl_typesupport_introspection_c__MessageMember ArduinoCommand_Request__rosidl_typesupport_introspection_c__ArduinoCommand_Request_message_member_array[2] = {
  {
    "cmd_type",  // name
