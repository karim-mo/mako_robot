...
#include "mako_nolang_interfaces/srv/detail/servo_control__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const mako_nolang_interfaces::srv::ServoControl_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mako_nolang_interfaces::srv::ServoControl_Request & ros_message)
{
  // Member: expression
  cdr >> ros_message.expression;
...
{
  auto typed_message =
    static_cast<const mako_nolang_interfaces::srv::ServoControl_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mako_nolang_interfaces::srv::ServoControl_Request *>(
    untyped_ros_message);
...
{
  return &mako_nolang_interfaces::srv::typesupport_fastrtps_cpp::_ServoControl_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mako_nolang_interfaces, srv, ServoControl_Request)() {
  return &mako_nolang_interfaces::srv::typesupport_fastrtps_cpp::_ServoControl_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_mako_nolang_interfaces
cdr_serialize(
  const mako_nolang_interfaces::srv::ServoControl_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: success
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mako_nolang_interfaces::srv::ServoControl_Response & ros_message)
{
  // Member: success
  {
    uint8_t tmp;
...
{
  auto typed_message =
    static_cast<const mako_nolang_interfaces::srv::ServoControl_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<mako_nolang_interfaces::srv::ServoControl_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &mako_nolang_interfaces::srv::typesupport_fastrtps_cpp::_ServoControl_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mako_nolang_interfaces, srv, ServoControl_Response)() {
  return &mako_nolang_interfaces::srv::typesupport_fastrtps_cpp::_ServoControl_Response__handle;
}
...
{
  return &mako_nolang_interfaces::srv::typesupport_fastrtps_cpp::_ServoControl__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mako_nolang_interfaces, srv, ServoControl)() {
  return &mako_nolang_interfaces::srv::typesupport_fastrtps_cpp::_ServoControl__handle;
}
