...
#include "mako_nolang_interfaces/srv/detail/servo_control__rosidl_typesupport_fastrtps_c.h"
...
using _ServoControl_Request__ros_msg_type = mako_nolang_interfaces__srv__ServoControl_Request;
...
size_t get_serialized_size_mako_nolang_interfaces__srv__ServoControl_Request(
  const void * untyped_ros_message,
...
static uint32_t _ServoControl_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_mako_nolang_interfaces__srv__ServoControl_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mako_nolang_interfaces
size_t max_serialized_size_mako_nolang_interfaces__srv__ServoControl_Request(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_mako_nolang_interfaces__srv__ServoControl_Request(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mako_nolang_interfaces, srv, ServoControl_Request)() {
...
using _ServoControl_Response__ros_msg_type = mako_nolang_interfaces__srv__ServoControl_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mako_nolang_interfaces
size_t get_serialized_size_mako_nolang_interfaces__srv__ServoControl_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ServoControl_Response__ros_msg_type * ros_message = static_cast<const _ServoControl_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_mako_nolang_interfaces__srv__ServoControl_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mako_nolang_interfaces
size_t max_serialized_size_mako_nolang_interfaces__srv__ServoControl_Response(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_mako_nolang_interfaces__srv__ServoControl_Response(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mako_nolang_interfaces, srv, ServoControl_Response)() {
...
// already included above
// #include "mako_nolang_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "mako_nolang_interfaces/srv/servo_control.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mako_nolang_interfaces, srv, ServoControl)() {
