...
#include "mako_nolang_interfaces/srv/detail/led_control__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // exp_type
#include "rosidl_runtime_c/string_functions.h"  // exp_type

// forward declare type support functions


using _LedControl_Request__ros_msg_type = mako_nolang_interfaces__srv__LedControl_Request;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: exp_type
  {
    const rosidl_runtime_c__String * str = &ros_message->exp_type;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: exp_type
  {
    std::string tmp;
    cdr >> tmp;
    if (!ros_message->exp_type.data) {
      rosidl_runtime_c__String__init(&ros_message->exp_type);
    }
    bool succeeded = rosidl_runtime_c__String__assign(
      &ros_message->exp_type,
      tmp.c_str());
    if (!succeeded) {
      fprintf(stderr, "failed to assign string into field 'exp_type'\n");
      return false;
    }
  }
...
size_t get_serialized_size_mako_nolang_interfaces__srv__LedControl_Request(
  const void * untyped_ros_message,
...
static uint32_t _LedControl_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_mako_nolang_interfaces__srv__LedControl_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mako_nolang_interfaces
size_t max_serialized_size_mako_nolang_interfaces__srv__LedControl_Request(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
static size_t _LedControl_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_mako_nolang_interfaces__srv__LedControl_Request(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mako_nolang_interfaces, srv, LedControl_Request)() {
...
using _LedControl_Response__ros_msg_type = mako_nolang_interfaces__srv__LedControl_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mako_nolang_interfaces
size_t get_serialized_size_mako_nolang_interfaces__srv__LedControl_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _LedControl_Response__ros_msg_type * ros_message = static_cast<const _LedControl_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_mako_nolang_interfaces__srv__LedControl_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_mako_nolang_interfaces
size_t max_serialized_size_mako_nolang_interfaces__srv__LedControl_Response(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
static size_t _LedControl_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_mako_nolang_interfaces__srv__LedControl_Response(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mako_nolang_interfaces, srv, LedControl_Response)() {
...
// already included above
// #include "mako_nolang_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "mako_nolang_interfaces/srv/led_control.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mako_nolang_interfaces, srv, LedControl)() {
