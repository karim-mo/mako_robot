...
#include <stddef.h>
#include "mako_nolang_interfaces/srv/detail/servo_control__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  mako_nolang_interfaces__srv__ServoControl_Request__init(message_memory);
}

void ServoControl_Request__rosidl_typesupport_introspection_c__ServoControl_Request_fini_function(void * message_memory)
{
  mako_nolang_interfaces__srv__ServoControl_Request__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember ServoControl_Request__rosidl_typesupport_introspection_c__ServoControl_Request_message_member_array[1] = {
  {
    ...
    offsetof(mako_nolang_interfaces__srv__ServoControl_Request, expression),  // bytes offset in struct
    NULL,  // default value
...
static const rosidl_typesupport_introspection_c__MessageMembers ServoControl_Request__rosidl_typesupport_introspection_c__ServoControl_Request_message_members = {
  ...
  1,  // number of fields
  sizeof(mako_nolang_interfaces__srv__ServoControl_Request),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mako_nolang_interfaces, srv, ServoControl_Request)() {
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  mako_nolang_interfaces__srv__ServoControl_Response__init(message_memory);
}

void ServoControl_Response__rosidl_typesupport_introspection_c__ServoControl_Response_fini_function(void * message_memory)
{
  mako_nolang_interfaces__srv__ServoControl_Response__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember ServoControl_Response__rosidl_typesupport_introspection_c__ServoControl_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(mako_nolang_interfaces__srv__ServoControl_Response, success),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers ServoControl_Response__rosidl_typesupport_introspection_c__ServoControl_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(mako_nolang_interfaces__srv__ServoControl_Response),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_mako_nolang_interfaces
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mako_nolang_interfaces, srv, ServoControl_Response)() {
...
static rosidl_typesupport_introspection_c__ServiceMembers mako_nolang_interfaces__srv__detail__servo_control__rosidl_typesupport_introspection_c__ServoControl_service_members = {
  "mako_nolang_interfaces__srv",  // service namespace
  "ServoControl",  // service name
  // these two fields are initialized below on the first access
  NULL,  // request message
  // mako_nolang_interfaces__srv__detail__servo_control__rosidl_typesupport_introspection_c__ServoControl_Request_message_type_support_handle,
  NULL  // response message
  // mako_nolang_interfaces__srv__detail__servo_control__rosidl_typesupport_introspection_c__ServoControl_Response_message_type_support_handle
};

static rosidl_service_type_support_t mako_nolang_interfaces__srv__detail__servo_control__rosidl_typesupport_introspection_c__ServoControl_service_type_support_handle = {
  0,
  &mako_nolang_interfaces__srv__detail__servo_control__rosidl_typesupport_introspection_c__ServoControl_service_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mako_nolang_interfaces, srv, ServoControl)() {
  if (!mako_nolang_interfaces__srv__detail__servo_control__rosidl_typesupport_introspection_c__ServoControl_service_type_support_handle.typesupport_identifier) {
    mako_nolang_interfaces__srv__detail__servo_control__rosidl_typesupport_introspection_c__ServoControl_service_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  rosidl_typesupport_introspection_c__ServiceMembers * service_members =
    (rosidl_typesupport_introspection_c__ServiceMembers *)mako_nolang_interfaces__srv__detail__servo_control__rosidl_typesupport_introspection_c__ServoControl_service_type_support_handle.data;

  if (!service_members->request_members_) {
    service_members->request_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mako_nolang_interfaces, srv, ServoControl_Request)()->data;
  }
  if (!service_members->response_members_) {
    service_members->response_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mako_nolang_interfaces, srv, ServoControl_Response)()->data;
  }

  return &mako_nolang_interfaces__srv__detail__servo_control__rosidl_typesupport_introspection_c__ServoControl_service_type_support_handle;
}
