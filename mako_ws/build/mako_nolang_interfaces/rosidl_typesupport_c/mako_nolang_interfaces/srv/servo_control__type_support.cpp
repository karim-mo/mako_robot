...
static const _ServoControl_Request_type_support_symbol_names_t _ServoControl_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mako_nolang_interfaces, srv, ServoControl_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mako_nolang_interfaces, srv, ServoControl_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, mako_nolang_interfaces, srv, ServoControl_Request)() {
  return &::mako_nolang_interfaces::srv::rosidl_typesupport_c::ServoControl_Request_message_type_support_handle;
}
...
static const _ServoControl_Response_type_support_symbol_names_t _ServoControl_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mako_nolang_interfaces, srv, ServoControl_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mako_nolang_interfaces, srv, ServoControl_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_mako_nolang_interfaces
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, mako_nolang_interfaces, srv, ServoControl_Response)() {
  return &::mako_nolang_interfaces::srv::rosidl_typesupport_c::ServoControl_Response_message_type_support_handle;
}
...
static const _ServoControl_type_support_symbol_names_t _ServoControl_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mako_nolang_interfaces, srv, ServoControl)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mako_nolang_interfaces, srv, ServoControl)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, mako_nolang_interfaces, srv, ServoControl)() {
  return &::mako_nolang_interfaces::srv::rosidl_typesupport_c::ServoControl_service_type_support_handle;
}
